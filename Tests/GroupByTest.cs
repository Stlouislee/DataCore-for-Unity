...
namespace AroAro.DataCore.Tests
{
    ...
    /// on similar data. DataFrameGroupByTest additionally covers Min/Max and multi-column.
    /// See also: issue #73.
    /// </summary>
    [TestFixture]
    public class GroupByTest
    {
        ...
        public void TestGroupByAPI()
        {
            ...
            Assert.That(sumResult.Rows.Count, Is.EqualTo(2), "Sum should produce 2 groups");
            ...
            Assert.That(meanResult.Rows.Count, Is.EqualTo(2), "Mean should produce 2 groups");
            VerifyGroupByValues(meanResult, "value", 30.0, 30.0, "Mean");

            // --- Count: A = 3, B = 2 ---
            var countResult = groupBy.Count(valueColumn);
            Assert.That(countResult.Rows.Count, Is.EqualTo(2), "Count should produce 2 groups");
